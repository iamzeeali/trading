...
const AddCustomer = ({ addCustomer, populateCities, cities, history }) => {
  ...
  return (
    <React.Fragment>
      <h3 className="lead ">
        {" "}
        <Link to="/customers" className="pr-4">
...
export default connect(mapStateToProps, { addCustomer, populateCities })(
